...
const Login = () => {
  ...
  return (<center>
    ...
    <div className="containr inp">
        ...
        <button className="btn btn-primary" type="button" onClick={printdata}>Login</button>
        <p className='existAccount'>Don't have an account? <Link to='/signup' className='linkLogin'>Register Here!</Link></p>
    </div></div>
    </center>
  )
}
